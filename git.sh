...
if [ -z "$NEEDS_TAG" ]; then
    ...
    git push --set-upstream -f --tag origin https://abhinavvashishat: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@github.com/abhinavvashishat/react-native-starter.git $NEW_TAG
else
